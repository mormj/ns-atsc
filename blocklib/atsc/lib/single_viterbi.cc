...
const int single_viterbi::d_was_sent[4][4] = {
    { 0, 2, 4, 6 },
    { 0, 2, 4, 6 },
    { 1, 3, 5, 7 },
    { 1, 3, 5, 7 },
...
const int single_viterbi::d_transition_table[4][4] = {
    { 0, 2, 0, 2 },
    { 2, 0, 2, 0 },
    { 1, 3, 1, 3 },
    { 3, 1, 3, 1 },
...
single_viterbi::single_viterbi() { reset(); }

float single_viterbi::best_state_metric() const { return d_best_state_metric; }

char single_viterbi::decode(float input)
{
